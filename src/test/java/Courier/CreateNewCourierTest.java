...
public class CreateNewCourierTest {
    ...
    @Description("Test /api/v1/courier with dublicate courier data. Return 409 and message: Этот логин уже используется. Попробуйте другой.")
    public void createNewCourierWithExistingCourierLoginExpectedStatus409() {
        login = "dublCourier";
        password = "4321";
        firstName = "dublCourier";
        CourierSerializer courierJsonData = new CourierSerializer(login, password, firstName);
        ...
        MatcherAssert.assertThat(dublicateRes.as(CourierCreateDeserializer.class).getMessage(), equalTo("Этот логин уже используется. Попробуйте другой."));
    }
